        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4 text-blue-600">Notre Vision</h3>
                <p className="text-gray-600">
